...
|action|string|50|是|调用行为<br>payoutPayout(固定参数值) - Ex:"action":"payoutPayout"|
...
|withdrawChannel|int ||是|支付管道<br> 详细内容请参考第12章 - Ex:支付管道支付管道名称12	RDPawnshop|
|payTime|DateTime||是|支付时间<br> (yyyy-MM-dd HH:mm:ss) - 出纳支付时间|
