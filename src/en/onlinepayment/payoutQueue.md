...
### When making a payment to a bank, call the API to send out the data format content:<font color = red>（When conducting bank transactions, please first go to the 10.6 to obtain the bank code interface to obtain the currently available bank list） </font>
