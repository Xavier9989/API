...
|withdrawChannel|int||  Y| Designated payment channel code - refer to Chapter 9 for detailed pipeline instructions[Channel code value](../Paymentpipeline/Paymentpipeline.md)|
